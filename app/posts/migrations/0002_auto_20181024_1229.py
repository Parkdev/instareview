# Generated by Django 2.1.2 on 2018-10-24 03:29
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            name='hashtag',
            options={'verbose_name': '해쉬태그', 'verbose_name_plural': '해쉬태그 목록'},
        ),
        migrations.AlterModelOptions(
            name='post',
        ...
        migrations.AlterField(
            model_name='comment',
            name='tags',
            field=models.ManyToManyField(blank=True, to='posts.HashTag', verbose_name='해쉬태그'),
        ),
        migrations.AlterField(
            model_name='hashtag',
            name='name',
